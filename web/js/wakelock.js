// wakelock.js -- the opt-in "keep the screen on".
//
...
export const wakeLock = {
  ...
  // secure reports whether the page may use it here. Wake Lock is a secure
  // context API, and phone mode is plain HTTP on a private address - which
  // is not a secure context, so the API is simply absent there. Without this
  // distinction the UI would tell a phone that its browser cannot keep the
  // screen on, when the browser can and the address is the reason.
  secure() {
