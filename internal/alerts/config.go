...
// Config holds the rule thresholds. The defaults are the ones AUFGABEN.md
// T6.1 names; the command line exposes the two a player is most likely to
// want to change.
//
...
// DefaultConfig returns the thresholds of AUFGABEN.md T6.1.
