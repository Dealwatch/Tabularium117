...
// phase 3: its columns follow the rule engine of internal/alerts (T6.1)
...
// schema1 is the initial schema (task T3.1), following KONZEPT.md section 4.
//
...
// schema2 adds the alert table (task T6.2).
//
