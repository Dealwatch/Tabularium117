...
// TestReplayAcceptance is the acceptance criterion of task T1.8: replaying the
...
// development gets real history data without the game (task T3.2).
func TestReplayWritesHistory(t *testing.T) {
	...
	// The console summary of T1.8 must survive the extra callback.
