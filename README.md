...
verbinden. Beim ersten Mal fragt die Windows-Firewall, ob Tabularium 117 im
...
(10.x, 172.16-31.x, 192.168.x) can connect. The first time, the Windows
...
Architektur, Datenmodell, API), `AUFGABEN.md` (Aufgabenliste),
`docs/protocol.md` (Pipe-Protokoll), `docs/release.md` (Release-Checkliste),
